...
APPS = [
    ...
    },
    {
        ...
        "tagline": "Mac OS X 10.4 Tiger 実機向けの軽量Quick Look代替。Finderでファイルを選んでSpaceキーでプレビュー（JPG/PNG/PDF/TXT）",
        "tagline_en": "A lightweight Quick Look substitute for Mac OS X 10.4 Tiger — select a file in the Finder, press Space, and a preview appears (JPG/PNG/PDF/TXT).",
        "platform": "PowerPC Mac (Tiger) 向け",
